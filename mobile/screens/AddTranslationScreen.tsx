...
export default function AddTranslationScreen() {
  ...
  const [autoGeneratedTranslation, setAutoGeneratedTranslation] =
    useState<TranslationFull | null>(null);
  ...
  const handleAddTranslation = async () => {
    if (autoGeneratedTranslation) {
      if (autoGeneratedTranslation.translatedWord !== translation) {
        try {
          await apiPatchTranslation({
            translationID: autoGeneratedTranslation.id,
            translationData: {
  ...
  const handleAutoTranslate = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setAutoGeneratedTranslation(response.data);
      }
    } catch (error) {
      console.log(error);
    } finally {
